    ...
    <main className="flex flex-col items-center py-10">
      ...
      <div className="flex mx-auto container ">
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch p-4">
          <div className=" rounded-[30px_90px_25px_80px/90px_25px_80px_30px]  border-2 border-sky-600/20 p-8 flex flex-col transition-all hover:-translate-y-2 hover:rotate-1 hover:shadow-2xl relative overflow-hidden">
          ...
          <div className="wobbly-card p-8 flex flex-col scale-105 shadow-xl z-10 transition-all hover:-translate-y-2 hover:-rotate-1 relative border-4 border-dashed border-white/30 bg-primary text-on-primary">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-secondary-container text-white px-6 py-1 rounded-full font-label-md text-sm shadow-md whitespace-nowrap">
              Phổ biến nhất
            </div>
            <div className="absolute top-0 right-0 p-4 opacity-20">
              <span className="material-symbols-outlined text-6xl" data-icon="auto_awesome" data-weight="fill">
                auto_awesome
              </span>
            </div>

<div className="h-2 w-24 bg-white mb-6 rounded-full opacity-50"></div>
<h3 className="font-headline-lg text-headline-lg mb-2">Gói Năng Khiếu</h3>
<p className="font-body-md mb-6 opacity-90">Dành cho các bé muốn phát triển kỹ năng chuyên sâu.</p>
<div className="mb-8">
...
<div className="flex items-center gap-3">
<span className="material-symbols-outlined" data-icon="format_paint">format_paint</span>
<span className="font-body-md">Dụng cụ miễn phí</span>
</div>
<div className="flex items-center gap-3">
<span className="material-symbols-outlined" data-icon="gallery_thumbnail">gallery_thumbnail</span>
<span className="font-body-md">Triển lãm cuối khóa</span>
</div>
<div className="flex items-center gap-3">
