        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1 space-y-5">
            <div className="flex items-center gap-3">
              <img src="/logo.png" alt="Vẽ zì đó logo" width={70} className="object-contain invert" />
            </div>
            <p className="text-xs text-gray-400 font-semibold leading-relaxed">
              Lớp học vẽ sáng tạo dành cho trẻ em từ 4-12 tuổi. Nuôi dưỡng năng khiếu hội họa và phát triển tư duy sáng tạo toàn diện.
            </p>
            {/* Social */}
            <div className="flex gap-3 pt-2">
              ...
              >
                <img src="/facebook.png" alt="Facebook" width={18} className="invert" />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-xs font-semibold text-gray-400">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:0348823095" className="hover:text-white transition-colors">
                  0348.823.095 (Cô Phụng)
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 shrink-0 text-sky-400" />
                <a href="mailto:lienhe@vezido.edu.vn" className="hover:text-white transition-colors">
      ...
      <div className="border-t border-white/10 px-4 py-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 text-[11px] font-semibold text-gray-500">
          ...
          <div className="flex items-center gap-1.5">
            <img src="/nhan_vat.png" alt="mascot" width={28} className="object-contain  opacity-50" />
